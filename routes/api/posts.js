...
// DELETE api/posts/:id || Delete Posts by Id || Private
...
// DELETE api/posts/comment/:id/:comment_id || Delete comment on a Post || Private
router.delete('/comment/:id/:comment_id', auth, async (req, res) => {
  try {
    ...
    // Make sure user deleting the comment is the user that made the comment
